...
new_dict = {}
filtered_dict = {}
old_file = "" # replace this with the directory and file name of the original file
new_file = "" # replace this with the directory and file name of the new file
output_file = "" # replace this with the directory and file name of the file you would like the results to be returned to

with open('old_file.csv', 'rU') as f:
  reader = csv.reader(f)
  for row in reader:
    old_dict[row[0]] = 1

with open('new_file.csv', 'rU') as m:
  reader = csv.reader(m)
  for row in reader:
